...
/**
 * An {@code EntityAttributeValue} is the reification of a {@code ClassAttribute} plus a
 * value.
 *
...
public class EntityAttributeValue implements Serializable {
	...
	private EntityAttributeValue(final Long id, final Integer attributeId, final String attributeName,
			final Object attributeValue, final LocalDateTime createdTime, final String createdBy) {
		this.id = id;
	...
	public static EntityAttributeValue of(final Long id, final Integer attributeId, final String attributeName,
			final Object attributeValue, final LocalDateTime createdTime, final String createdBy) {
