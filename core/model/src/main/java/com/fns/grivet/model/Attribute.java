...
/**
 * An {@code Attribute} participates in the definition of a property in a
 * {@link ClassAttribute}. One or more {@code ClassAttribute} may share an
 * {@code Attribute}.
 *
...
public class Attribute implements Auditable<String> {
	...
	public static class AttributeBuilder {
		...
		/**
		 * The name of the attribute. Must be non-null, unique and less than 256
		 * characters.
		 * @return {@code this}.
		 */
		...
		public Attribute build() {
			return new Attribute(this.createdBy, this.updatedBy, this.createdTime, this.updatedTime, this.version,
					this.id, this.name, this.description);
		}

		@Override
		public String toString() {
			return "Attribute.AttributeBuilder(createdBy=" + this.createdBy + ", updatedBy=" + this.updatedBy
					+ ", createdTime=" + this.createdTime + ", updatedTime=" + this.updatedTime + ", version="
					+ this.version + ", id=" + this.id + ", name=" + this.name + ", description=" + this.description
					+ ")";
		}
	...
	public boolean equals(final Object o) {
		...
		if (this$name == null ? other$name != null : !this$name.equals(other$name))
			return false;
		final var this$description = this.getDescription();
		final var other$description = other.getDescription();
	...
	public int hashCode() {
		...
		final var $description = this.getDescription();
	...
	@Override
	public String toString() {
		return "Attribute(createdBy=" + this.getCreatedBy() + ", updatedBy=" + this.getUpdatedBy() + ", createdTime="
	...
	Attribute(final String createdBy, final String updatedBy, final LocalDateTime createdTime,
