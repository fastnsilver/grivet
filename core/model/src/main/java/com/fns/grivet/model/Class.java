...
public class Class implements Auditable<String> {
    ...
    public static class ClassBuilder {
        ...
        public Class build() {
            return new Class(this.createdBy, this.updatedBy, this.createdTime, this.updatedTime, this.version, this.id, this.name, this.description, this.validatable, this.jsonSchema);
        }

        @Override
        public String toString() {
            return "Class.ClassBuilder(createdBy=" + this.createdBy + ", updatedBy=" + this.updatedBy + ", createdTime=" + this.createdTime + ", updatedTime=" + this.updatedTime + ", version=" + this.version + ", id=" + this.id + ", name=" + this.name + ", description=" + this.description + ", validatable=" + this.validatable + ", jsonSchema=" + this.jsonSchema + ")";
        }
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (this.isValidatable() != other.isValidatable()) return false;
        ...
        if (this$jsonSchema == null ? other$jsonSchema != null : !this$jsonSchema.equals(other$jsonSchema)) return false;
        return true;
    }
    ...
    @Override
    public String toString() {
        return "Class(createdBy=" + this.getCreatedBy() + ", updatedBy=" + this.getUpdatedBy() + ", createdTime=" + this.getCreatedTime() + ", updatedTime=" + this.getUpdatedTime() + ", version=" + this.getVersion() + ", id=" + this.getId() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", validatable=" + this.isValidatable() + ", jsonSchema=" + this.getJsonSchema() + ")";
    }

    Class() {}

    Class(final String createdBy, final String updatedBy, final LocalDateTime createdTime, final LocalDateTime updatedTime, final long version, final Integer id, final String name, final String description, final boolean validatable, final String jsonSchema) {
        this.createdBy = createdBy;
        this.updatedBy = updatedBy;
        this.createdTime = createdTime;
        this.updatedTime = updatedTime;
