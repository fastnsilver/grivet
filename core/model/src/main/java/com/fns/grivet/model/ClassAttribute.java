...
public class ClassAttribute implements Auditable<String> {
    ...
    public static class ClassAttributeBuilder {
        ...
        public ClassAttribute build() {
            return new ClassAttribute(this.createdBy, this.updatedBy, this.createdTime, this.updatedTime, this.version, this.cid, this.aid, this.tid);
        }

        @Override
        public String toString() {
            return "ClassAttribute.ClassAttributeBuilder(createdBy=" + this.createdBy + ", updatedBy=" + this.updatedBy + ", createdTime=" + this.createdTime + ", updatedTime=" + this.updatedTime + ", version=" + this.version + ", cid=" + this.cid + ", aid=" + this.aid + ", tid=" + this.tid + ")";
        }
    }
    ...
    @Override
    public String toString() {
        return "ClassAttribute(createdBy=" + this.getCreatedBy() + ", updatedBy=" + this.getUpdatedBy() + ", createdTime=" + this.getCreatedTime() + ", updatedTime=" + this.getUpdatedTime() + ", version=" + this.getVersion() + ", cid=" + this.getCid() + ", aid=" + this.getAid() + ", tid=" + this.getTid() + ")";
    }

    ClassAttribute() {}

    ClassAttribute(final String createdBy, final String updatedBy, final LocalDateTime createdTime, final LocalDateTime updatedTime, final long version, final Integer cid, final Integer aid, final Integer tid) {
        this.createdBy = createdBy;
        this.updatedBy = updatedBy;
        this.createdTime = createdTime;
        this.updatedTime = updatedTime;
