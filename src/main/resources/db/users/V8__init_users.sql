...
insert into users(id, name, login, password) values (3,'Read-only User', 'readonly', '$2a$10$jT1ZkT7CGKBhMyvg39Q2feVEW84IAvQDkN9iCWHEKKmH1hbDd41Om'); 

insert into role(id, name) values (1,'ROLE_USER');
insert into role(id, name) values (2,'ROLE_ADMIN');
insert into role(id, name) values (3,'ROLE_READONLY');
