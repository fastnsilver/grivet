...
/**
 * Controller for resetting the token store.
 * 
...
public class AdminController {
    ...
    private GrivetUserApprovalHandler userApprovalHandler;

    @Autowired
    public AdminController(TokenStore tokenStore,
            @Qualifier("consumerTokenServices") ConsumerTokenServices tokenServices,
            GrivetUserApprovalHandler userApprovalHandler) {
        setTokenStore(tokenStore);
        setTokenServices(tokenServices);
        setUserApprovalHandler(userApprovalHandler);
    }
     ...
     */
    public void setUserApprovalHandler(GrivetUserApprovalHandler userApprovalHandler) {
