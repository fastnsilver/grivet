...
public class ClassRegistryService {
    ...
    public String register(JSONObject payload) {
        ...
        com.fns.globaldb.model.Class c = classRepository.findByName(type);
        if (c == null) {
            c = classRepository.save(new com.fns.globaldb.model.Class(type, description));
    ...
    public JSONArray all() {
        ...
        Iterable<com.fns.globaldb.model.Class> iterable = classRepository.findAll();
        Assert.notNull(iterable, "No types are registered!");
        Iterator<com.fns.globaldb.model.Class> it = iterable.iterator();
        com.fns.globaldb.model.Class c = null;
        while(it.hasNext()) {
           c = it.next();
    ...
    @Transactional
    public com.fns.globaldb.model.Class linkSchema(JSONObject payload) {
    ...
    @Transactional
    public com.fns.globaldb.model.Class unlinkSchema(String type) {
        com.fns.globaldb.model.Class c = classRepository.findByName(type);
